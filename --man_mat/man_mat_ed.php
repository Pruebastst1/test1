        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form name="f1" id="demo-form2"   method="POST" action="man_mat_p.php" enctype="multipart/form-data">
				...
				<div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="f_nombre"  value="<?php echo $v_mat_nombre ?>" oninput="validarMayusculas(this)" required>
                  </div>
                </div>

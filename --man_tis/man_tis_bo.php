...
<body>
  ...
  <?php
		   ...
		   $id_tis	= $_GET['id_tis'];
		   $consulta="select * from gd_tiposolicitud where tis_id = '$id_tis'";
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form name="f1" id="demo-form2"   method="POST" action="man_tis_p.php" enctype="multipart/form-data">
				...
				<div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="f_nombre"  value="<?php echo $v_tis_nombre ?>" oninput="validarMayusculas(this)" required>
                  </div>
                </div>
<div class="row mb-3">
                  ...
                  <div class="col-sm-10">
					...
					<input type="hidden" name="id_tis" value="<?php echo $v_tis_id ?>">
					<input type="submit" class="btn btn-danger" value="Borrar">
					<a href="man_tis.php" class="btn btn-success" >Volver</a>
                  </div>
                </div>

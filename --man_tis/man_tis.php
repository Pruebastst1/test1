        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p align="right"><a href="man_tis_ag.php"><button type="button" title="Agregar Nuevo" class="btn btn-primary"><i class="bi bi-plus-circle"></i> Agregar</button></a> </p>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
					     ...
					     <a href="man_tis_ed.php?id_tis=<?php echo $v_tis_id ?>"><button type="button" class="btn btn-success"><i class="bi bi-pencil"></i></button></a>
						 <a href="man_tis_bo.php?id_tis=<?php echo $v_tis_id ?>"><button type="button" class="btn btn-danger"><i class="bi bi-trash"></i></button></a>
				    </td>
                  </tr>

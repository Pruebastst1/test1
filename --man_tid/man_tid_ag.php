        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form name="FormTid" id="FormTid2" enctype="multipart/form-data">
				...
				<div class="row mb-3">
                  ...
                  <div class="col-sm-3">
                    <input type="text" class="form-control" name="f_codigo"  maxlength="5"  oninput="validarMayusculas(this)" required>
                  </div>
                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.success) {
                        ...
                        $('#FormTid2')[0].reset(); // Vaciar el formulario
                    } else {

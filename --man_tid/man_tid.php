        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p align="right"><a href="man_tid_ag.php"><button type="button" title="Agregar Nuevo" class="btn btn-primary"><i class="bi bi-plus-circle"></i> Agregar</button></a> </p>
              ...
              <table class="table datatable">
                ...
                <tbody>
				  <?php
				      $consulta="select * from gd_tiposdocto";
				  ...
				  ?>
                  <tr>
                    <th scope="row"><?php echo $v_tid_id ?></th>
                    <td><?php echo $v_tid_codigo ?></td>
					<td><?php echo $v_tid_nombre ?></td> 
                     
                    <td>
					     
					     <a href="man_tid_ed.php?id_tid=<?php echo $v_tid_id ?>"><button type="button" class="btn btn-success"><i class="bi bi-pencil"></i></button></a>
						 <a href="man_tid_bo.php?id_tid=<?php echo $v_tid_id ?>"><button type="button" class="btn btn-danger"><i class="bi bi-trash"></i></button></a>
				    </td>
                  </tr>

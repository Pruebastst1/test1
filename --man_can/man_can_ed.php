...
<body>
  ...
  <?php
		   ...
		   $id_can	= $_GET['id_can'];
		   $consulta="select * from gd_canales where can_id = '$id_can'";
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form name="f1" id="demo-form2"   method="POST" action="man_can_p.php" enctype="multipart/form-data">
				...
				<div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="f_nombre"  value="<?php echo $v_can_nombre ?>" oninput="validarMayusculas(this)" required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
					...
					<input type="hidden" name="id_can" value="<?php echo $v_can_id ?>">
					<input type="submit" class="btn btn-primary" value="Grabar">
					<a href="man_mat.php" class="btn btn-danger" >Volver</a>
                  </div>
                </div>
